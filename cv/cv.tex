...
\begin{tabular*}{6.86in}{@{\extracolsep{\fill}}lr}
  ...
  \href{mailto:siddharth@iffsid.com}{siddharth@iffsid.com} & \emph{Tel}: \textrm{+1 765-409-6947}\\
\end{tabular*}
\vspace{0.3in}
...
\begin{region} {Journal Publications in Review}{}{3}
  \begin{publication} {The Compositional Nature of Event Representations in the Human Brain}
    ...
    {Science}
    % {\url{http://iffsid.com/publications/jair2013.pdf}\label{j:5}}
    {}
  \end{publication}
  \begin{publication} {A Compositional Framework for Grounding Language Inference, Generation,
    ...
    % {\url{http://iffsid.com/publications/jair2013.pdf}\label{j:4}}
    {}
  \end{publication}
...
\begin{region} {Refereed Conference Publications}{{C}1}{7}
  \begin{publication} {Recognizing Human Activities from Partially Observed Videos}
    ...
    {pp.~2658--65 \hfill\small{[\poster]}\\ %412/1798 (22.9\%)
  ...
  \begin{publication} {Video In Sentences Out}
    ...
    {pp.~102--12 \hfill\small{[\oral]}\\ % 24/304 (8\%)
  ...
  \begin{publication} {A Visual Language Model for Estimating Object
    ...
    {pp.~4854--60 \hfill\small{[\oral]}\\ % 982/2004 (49\%)
  ...
  \begin{publication}{Learning Physically-Instantiated Game Play Through Visual Observation}
    ...
    {A. Barbu, N Siddharth, and J. M. Siskind}
    {IEEE International Conference on Robotics and Automation (ICRA)}
    {pp.~1879--86 \hfill\small{[\oral]}\\ % 856/2062 (42\%)
...
\clearpage
\begin{region} {Technical Reports}{{T}1}{4}
  \begin{publication} {Saying What You're Looking For: Linguistics Meets Video Search}
    {Sep 2013}
    {A. Barbu, N. Siddharth, and J. M. Siskind}
    {arXiv:1309.5174 \hfill\small{[submitted for review at CVPR 2014]}}
  ...
  \begin{publication} {Seeing What You're Told: Sentence-Guided Activity Recognition in Video}
    {Aug 2013}
    {N. Siddharth, A. Barbu, and J. M. Siskind}
    {arXiv:1308.4189\hfill\small{[submitted for review at CVPR 2014]}}
    {\url{http://arxiv.org/pdf/1308.4189v1}}
  \end{publication}
...
\item
  \begin{tabular*}{6.5in}{l@{\extracolsep{\fill}}r}
    Student Member, IEEE & \textit{Mar 2005 --}
  \end{tabular*}
\end{nonumregion}
...
\begin{nonumregion}{Other Activities}
